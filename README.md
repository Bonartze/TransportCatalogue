- Транспортный справочник, который принимает и выводит данные в формате Json, а также реализующий визуализация результата работы программы с помощью самодельной SVG библиотекой
